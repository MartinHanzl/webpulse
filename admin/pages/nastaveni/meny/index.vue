		...
		<LayoutContainer>
			<BaseTable
				...
				:columns="[
					...
					{ key: 'symbol_before', name: 'Symbol před', type: 'text', width: 80, hidden: true, sortable: true },
					{ key: 'symbol_after', name: 'Symbol za', type: 'text', width: 80, hidden: true, sortable: true },
