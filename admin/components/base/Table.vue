      ...
      <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
        <div class="inline-block min-w-full py-2 align-middle">
          <table class="min-w-full divide-y divide-gray-300">
            <thead>
              <tr>
                <th v-for="(column, key) in columns" :key="key" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6 lg:pl-8">
                  {{ column.name }}
                </th>
                <th
                  scope="col"
            ...
            <tbody class="divide-y divide-gray-200 bg-white">
              <tr
                ...
                :key="key"
              >
                <td v-for="(column, index) in columns" :key="index" :class="`whitespace-nowrap w-[${column.width}]/12 py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6 lg:pl-8`">
                  ...
                  <div v-if="column.type === 'status'">
                    <div v-if="item[column.key] === true" class="text-green-600 text-sm">
