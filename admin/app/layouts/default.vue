...
import { applyMenuOrder, useMenuOrder } from '~/composables/useMenuOrder';
...
async function reloadMenuOrder() {
  ...
  navigation.value = applyMenuOrder(menuSections, rows);
}

watch(selectedSiteHash, reloadMenuOrder, { immediate: true });
