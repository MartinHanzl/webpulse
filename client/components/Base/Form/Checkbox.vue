      ...
      <div class="flex gap-3">
        <div class="flex h-6 shrink-0 items-center">
          <div class="group grid size-4 grid-cols-1">
            <input
              ...
              :checked="checked"
              :disabled="disabled"
              class="col-start-1 row-start-1 appearance-none rounded border border-grayLight bg-primary focus:bg-secondary focus:border-secondary checked:border-secondary checked:bg-dark indeterminate:border-secondary indeterminate:bg-dark active:bg-dark active:border-secondary disabled:border-secondary disabled:bg-secondary disabled:checked:bg-secondary"
            />
            <svg
        ...
        <div class="text-xs lg:text-sm/6">
          <label
            v-if="type === 'badge'"
            :for="name"
            :class="badgeClass(color)"
            >{{ label }}</label
          >
          <label v-else :for="name" class="font-medium text-gray-900">{{
            label
          }}</label>
        </div>
      </div>
