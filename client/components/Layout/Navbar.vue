...
<template>
	<header class="backdrop-blur-md w-full">
		<nav
			class="mx-auto flex max-w-xxl items-center justify-between lg:px-16 p-6 lg:p-0"
			aria-label="Global"
		>
					...
					<div class="-my-6 divide-y divide-gray-500/10">
						...
						<div class="py-6 flex justify-between">
							<NuxtLink
								v-for="locale in locales"
								:key="locale.code"
								class="rounded-lg py-2 px-2.5 pr-3 text-sm/7 text-primary hover:bg-primary hover:text-light"
								:to="switchLocalePath(locale.code)"
							>
								<img
									:src="'/static/img/flags/' + locale.code + '.svg'"
