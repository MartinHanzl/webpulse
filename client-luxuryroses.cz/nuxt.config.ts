...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    public: {
      ...
      // Active theme for this site. The single florist page hard-wires
      // data-demo="luxuryroses"; kept here for consistency.
      siteTheme: process.env.SITE_THEME ?? 'luxuryroses',
      siteHash:
