						...
						<MenuItems>
							...
							>
								<a
									...
									href="#"
									@click="action.type === 'edit' ? router.push(action.path) : action.type === 'add-dialog' ? emit('add-dialog') : action.type === 'filter-dialog' ? emit('filter-dialog') : action.type === 'save' ? emit('save') : null"
								>
									Documentation
								</a>
							</MenuItem>
