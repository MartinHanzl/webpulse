...
export default defineNuxtConfig({
  ...
  app: {
    head: {
      ...
      script: [
        {
          src: 'https://www.googletagmanager.com/gtag/js?id=G-C3CKR3BW8S',
          async: true,
        },
        {
          innerHTML:
            "window.dataLayer = window.dataLayer || [];function gtag(){dataLayer.push(arguments);}gtag('js', new Date());gtag('config', 'G-C3CKR3BW8S');",
        },
      ],
    },
  },
